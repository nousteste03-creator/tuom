  ...
  // Mapa de ícones que você já foi adicionando em assets/icons/services
  const SERVICE_ICONS: Record<string, any> = {
    netflix: require("@/assets/icons/subscriptions/netflix.png"),
    // quando você adicionar mais, só ir incluindo aqui:
  ...
  export default function AddSubscription() {
    ...
    // Serviço final que vamos salvar (ou da lib, ou digitado manual)
    ...
    return (
      <Screen>
        <View style={{ flex: 1, backgroundColor: "#0B0B0C" }}>
          ...
          >
            {/* MINI-HERO COM BLUR (estilo home, mas menor) */}
            <View
              style={{
                borderRadius: 26,
                overflow: "hidden",
            ...
            >
              ...
              >
                ...
                SERVICE_ICONS[selectedService.icon] ? (
                  <Image
                    source={SERVICE_ICONS[selectedService.icon]}
                ...
                >
                  <ScrollView keyboardShouldPersistTaps="handled">
                    {filteredServices.map((item) => {
                      const iconSource =
                        item.icon && SERVICE_ICONS[item.icon]
